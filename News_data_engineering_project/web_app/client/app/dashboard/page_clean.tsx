        ...
        <div className="min-h-screen bg-black text-white">
            ...
            <div className="relative z-10 max-w-[1800px] mx-auto px-6 py-20">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-6 h-[350px]">
                    {/* Revenue vs Profit -> Volume vs Sentiment Impact */}
                    ...
                    {/* Category of Customers -> Topic Distribution */}
                    ...
                    {/* Cart Conversion -> Processing Efficiency */}
                    <Card className="lg:col-span-3 bg-[#1a1b1e] border-[#2c2d32] h-full flex flex-col">
                        <CardHeader className="pb-2">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 h-[400px]">
                    {/* Purchase Funnel -> ETL Pipeline Funnel */}
                    ...
                    {/* Sales by Product -> Treemap (TreeMap is complex in Recharts, simpler Mock visualization here or port from Analytics if verified) */}
                    {/* Using a custom Block grid to mimic Treemap for stability as Recharts Treemap needs specific data structure */}
                    ...
                    {/* Product Distribution -> Scatter Plot */}
                    <Card className="lg:col-span-3 bg-[#1a1b1e] border-[#2c2d32] h-full flex flex-col">
                        <CardHeader className="pb-2">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 pb-12">
                ...
                <Card className="lg:col-span-8 bg-[#1a1b1e] border-[#2c2d32] overflow-hidden">
                    ...
                    <CardContent className="h-[300px] relative bg-[url('https://upload.wikimedia.org/wikipedia/commons/e/ec/World_map_blank_without_borders.svg')] bg-no-repeat bg-center bg-contain opacity-80 mix-blend-screen">
                        ...
                        {[
                            { top: '30%', left: '25%', color: 'bg-red-500', name: 'New York' },
                            { top: '35%', left: '48%', color: 'bg-cyan-500', name: 'London' },
                            { top: '45%', left: '55%', color: 'bg-purple-500', name: 'Dubai' },
                            { top: '55%', left: '80%', color: 'bg-green-500', name: 'Tokyo' },
                            { top: '70%', left: '85%', color: 'bg-orange-500', name: 'Sydney' },
                            { top: '60%', left: '20%', color: 'bg-yellow-500', name: 'Brasilia' },
                        ].map((pin, i) => (
